...
namespace BinaryDataSerialization
{
    ...
    /// </summary>
    /// <seealso cref="BinaryDataSerializer" />
    public class BindingInfo
    {
        ...
        ///     using RelativeSourceMode <see cref="BinaryDataSerialization.RelativeSourceMode.Self" />.
        /// </summary>
        /// <param name="path">The path to the source member.</param>
        /// <param name="converterType">An optional converter.</param>
        /// <param name="converterParameter">An optional converter parameter.</param>
        ...
        ///     <see cref="BinaryDataSerialization.RelativeSourceMode.FindAncestor" /> RelativeSourceMode.
        ...
        /// <summary>
        ///     Gets or sets a <see cref="BinaryDataSerialization.RelativeSourceMode" /> value that describes the location of the
