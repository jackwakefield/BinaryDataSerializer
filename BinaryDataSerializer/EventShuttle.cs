...
namespace BinaryDataSerialization
{
    internal class EventShuttle
    {
        ...
        public void OnMemberSerialized(ValueNode sender, string name, object value, BinaryDataSerializationContext context,
        ...
        public void OnMemberSerializing(ValueNode sender, string name, BinaryDataSerializationContext context,
            FieldLength offset, FieldLength localOffset)
        {
