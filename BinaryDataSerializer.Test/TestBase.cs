...
namespace BinaryDataSerialization.Test
{
    ...
    {
        protected static readonly BinaryDataSerializer Serializer = new BinaryDataSerializer();

        protected static readonly BinaryDataSerializer SerializerBe = new BinaryDataSerializer
        {
